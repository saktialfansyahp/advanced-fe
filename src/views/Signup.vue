<template>
  ...
  <main class="main-content mt-0 pb-1">
    <div class="page-header align-items-start pt-5 pb-5 m-2 border-radius-lg" style="background-image: url('https://raw.githubusercontent.com/creativetimofficial/public-assets/master/argon-dashboard-pro/assets/img/signup-cover.jpg'); background-position: center;">
